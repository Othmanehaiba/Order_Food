...
<h2 class="font-oleo text-white text-[2rem]">My Panier</h2>
          ...
          <button id="close-panier-btn" 
                  class="absolute top-4 right-4 text-white opacity-70 hover:opacity-100 text-3xl font-bold">
            &times; 
          </button>
</div>
...
export function openPanier() {
  ...
  const closeBtn = document.getElementById('close-panier-btn');
  ...
  closeBtn.addEventListener('click', toggleThePanier);

  overlay.addEventListener('click', toggleThePanier);
}
